...
```mermaid
flowchart LR
    A["Molecular physics<br/>absorption · opacity"]
    B["Atmospheric physics<br/>radiation · convection"]
    C["Planetary climate<br/>3D circulation · evolution"]
    D["Observable worlds<br/>spectra · model grids"]
    E["Inference<br/>comparison with observations"]

    A --> B --> C --> D --> E

    style A fill:#172554,stroke:#60a5fa,color:#ffffff
    style B fill:#164e63,stroke:#67e8f9,color:#ffffff
    style C fill:#14532d,stroke:#86efac,color:#ffffff
    style D fill:#713f12,stroke:#fde047,color:#ffffff
    style E fill:#581c87,stroke:#d8b4fe,color:#ffffff
```
